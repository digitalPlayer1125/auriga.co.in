...
![logo](https://mydigigaon.com/assets/img/logo.png)
...
2. Clone your fork:
    ...
    `git clone https://github.com/<username>/auriga.co.in.git`
    
    Where `<username>` is your github username.

3. Add the base repository as a remote:
    
    `git remote add upstream https://github.com/digitalPlayer1125/auriga.co.in.git`
